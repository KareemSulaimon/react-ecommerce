...
useEffect(() => {
  ...
  return  (
    <div className='flex flex-col max-w-screen-xl mx-auto items-center bg-white sticky top-0 z-10'>
        <div className='flex flex-col w-[90%] gap-14'>
            <Form 
                ...
                search ? (
                  <div className='flex w-full h-full items-center justify-around'>
                        ...
                        type="text" value={searchQuery} onChange={handleInputChange} 
                          placeholder='Search our store' className='w-3/4 border-none outline-0'/>
          ...
          {
          suggest.length === 0 ? false : 
          <div className='flex flex-col w-full h-full gap-10 absolute top-20 '>
                <div 
      ...
      {
        suggest.length > 0  ? false : 
            <div className= {`w-3/4 h-20 flex items-center justify-between bg-[${bg}]`}>
            <Link  className='hover:underline underline-offset-8 decoration-2'>
            What's New
            </Link>
            <Link 
            onMouseOver={() => { 
